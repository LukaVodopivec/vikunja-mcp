...
/**
 * Validate string input shape only.
 *
 * Trust boundary note:
 * - Vikunja API and rendering layers own content safety and output encoding.
 * - MCP layer keeps structural constraints (type/length) and does not mutate content.
 */
